...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://github.com/Rashidsidhik/React-portfolio")
      .then((res) => res.json())
      .then((json) => {
  ...
  return (
    <footer>
      ...
      <a className="footer-link" href="https://github.com/Rashidsidhik/React-portfolio">
        <span>
          <AiOutlineStar /> {gitHubInfo.stars} <BiGitRepoForked />
          {gitHubInfo.forks} - Give this project a star!
        </span>
        <p>
          <span>▷</span> Designed and built by Rashid Sidhik &copy; {currentYear}
        </p>
      ...
      <motion.a
        href="https://github.com/rashidsidhik/"
        initial="initial"
        whileHover="hover"
        whileTap="tap"
